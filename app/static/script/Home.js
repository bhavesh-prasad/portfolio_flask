...
document.addEventListener("DOMContentLoaded", function(event) {
    ...
    window.onload = function() {
        ...
        t.to('.downArrow',{opacity:"100%", duration:1.5} , "-=1");
